...
using IntegerEncodedVector = std::vector<IntegerEncodedValue>;
...
std::vector<u8> Decompress(const uint8_t * data, uint32_t width, uint32_t height, uint32_t depth, uint32_t block_width, uint32_t block_height)
{
    u32 blockIdx = 0;
